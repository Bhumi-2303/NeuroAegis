...
EVENTS_CSV_PATH = os.path.join(BASE_DIR, "research/experiments/gnn/final_test_event_details.csv")
PATIENTS_CSV_PATH = os.path.join(BASE_DIR, "research/experiments/gnn/final_test_patient_metrics.csv")
...
class TestPhase4ACScientificAudit(unittest.TestCase):
    ...
    def test_08_threshold_reproducibility(self):
        ...
        corr_path = os.path.join(BASE_DIR, "research/experiments/gnn/audit/training_correlation_matrix.npy")
