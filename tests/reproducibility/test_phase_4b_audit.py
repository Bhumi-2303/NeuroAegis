...
FROZEN_GRAPH_CFG = os.path.join(BASE_DIR, "research/experiments/gnn/frozen_graph_config.json")
FROZEN_GRAPH_ADJ = os.path.join(BASE_DIR, "research/experiments/gnn/frozen_graph_adjacency.csv")
...
class TestPhase4BAudit(unittest.TestCase):
    ...
    def test_15_preprocessing_is_unchanged(self):
        ...
        with open(os.path.join(BASE_DIR, "research/experiments/windowing_labeling/preprocessing_config.json"), "r") as f:
            p_cfg = json.load(f)
        if "filters" in p_cfg:
