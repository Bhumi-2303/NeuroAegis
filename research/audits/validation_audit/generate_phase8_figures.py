...
FIG_DIR = os.path.join(BASE_DIR, "research/audits/validation_audit/figures")
PUB_FIG_DIR = os.path.join(BASE_DIR, "research/audits/validation_audit/publication/figures")
...
def plot_fig3_cohort():
    ...
    pat_df = pd.read_csv(os.path.join(BASE_DIR, "research/experiments/model_c/results/final_test_patient_results.csv"))
...
def plot_fig5_ablation():
    cmp_df = pd.read_csv(os.path.join(BASE_DIR, "research/experiments/ablation/results/model_comparison.csv"))
...
def plot_fig6_confusion_matrix():
    with open(os.path.join(BASE_DIR, "research/audits/validation_audit/final_results/authoritative_final_metrics.json")) as f:
        m = json.load(f)
...
def plot_fig7_roc():
    ...
    df_c = pd.read_csv(os.path.join(BASE_DIR, "research/experiments/model_c/results/final_test_predictions.csv"))
    df_b = pd.read_csv(os.path.join(BASE_DIR, "research/experiments/gnn_candidates/final_test_predictions.csv"))
...
def plot_fig9_event_timeline():
    events = pd.read_csv(os.path.join(BASE_DIR, "research/experiments/model_c/results/final_test_event_results.csv"))
...
def plot_fig13_siena_zero_shot():
    ...
    # Events breakdown
    evt_df = pd.read_csv(os.path.join(BASE_DIR, "research/experiments/siena/results/siena_zero_shot_event_results.csv"))
...
def plot_fig15_xai_channels():
    xai_df = pd.read_csv(os.path.join(BASE_DIR, "research/experiments/xai/results/channel_attribution_summary.csv"))
...
def plot_fig16_xai_temporal():
    temp_df = pd.read_csv(os.path.join(BASE_DIR, "research/experiments/xai/results/temporal_attribution_summary.csv"))
...
def plot_fig17_xai_faithfulness():
    faith_df = pd.read_csv(os.path.join(BASE_DIR, "research/experiments/xai/results/insertion_deletion_results.csv"))
