...
def verify_checkpoint_and_graph() -> Dict[str, Any]:
    ...
    graph_config_path = os.path.join(BASE_DIR, "research/experiments/gnn/frozen_graph_config.json")
...
def recompute_final_metrics() -> Dict[str, Any]:
    ...
    # Event results
    event_path = os.path.join(BASE_DIR, "research/experiments/model_c/results/final_test_event_results.csv")
    ...
    # Patient results
    patient_path = os.path.join(BASE_DIR, "research/experiments/model_c/results/final_test_patient_results.csv")
    ...
    claims = [
        {
            ...
            "supporting_artifact": "research/experiments/ablation/results/false_alarm_results.csv",
        ...
        },
        {
            ...
            "supporting_artifact": "research/experiments/model_c/results/final_test_event_results.csv",
            "supported_status": "FULLY SUPPORTED",
            "confidence_strength": "High",
        ...
        },
        {
            ...
            "supporting_artifact": "research/experiments/ablation/results/model_comparison.csv",
            "supported_status": "FULLY SUPPORTED",
        ...
        },
        {
            ...
            "supporting_artifact": "research/experiments/ablation/results/patient_level_results.csv",
        ...
        },
        {
            ...
            "supporting_artifact": "research/experiments/siena/results/siena_zero_shot_summary.json",
            "supported_status": "SUPPORTED WITH QUALIFICATION",
            "confidence_strength": "Moderate",
        ...
        },
        {
            ...
            "supporting_artifact": "research/experiments/siena/results/siena_adapted_summary.json",
            "supported_status": "SUPPORTED WITH QUALIFICATION",
            "confidence_strength": "Moderate",
        ...
        },
        {
            ...
            "supporting_artifact": "research/experiments/xai/results/insertion_deletion_results.csv",
            "supported_status": "FULLY SUPPORTED",
            "confidence_strength": "High",
        ...
        },
        {
            ...
            "supporting_artifact": "research/experiments/model_c/figures/real_time_inference_profile.png",
        ...
        },
        {
            ...
            "supporting_artifact": "research/experiments/ablation/results/detection_delay_results.csv",
            "supported_status": "FULLY SUPPORTED",
            "confidence_strength": "High",
    ...
    manifest = {
        ...
        "cryptographic_hashes": {
            "frozen_checkpoint_pt": {
                "path": "artifacts/checkpoints/frozen_cnn_gnn_gru.pt",
                "sha256": get_file_sha256(os.path.join(BASE_DIR, "artifacts/checkpoints/frozen_cnn_gnn_gru.pt")),
                "expected": "2ec84897c39d31d68cfbf1f7e5c8708d5073fe19450576bf4f9132929c1832ca"
            },
            "spatial_graph_adjacency_csv": {
                "path": "research/experiments/gnn/frozen_graph_adjacency.csv",
                "sha256": get_file_sha256(os.path.join(BASE_DIR, "research/experiments/gnn/frozen_graph_adjacency.csv")),
                "expected": "062c6aaffdc32ea1b9b5b97c82c224d40e0ab3b7e9b2afad5fd5b3e5f52db48e"
            },
            "spatial_graph_config_json": {
                "path": "research/experiments/gnn/frozen_graph_config.json",
                "sha256": get_file_sha256(os.path.join(BASE_DIR, "research/experiments/gnn/frozen_graph_config.json"))
            },
            "channel_order_json": {
            ...
            "chbmit_window_index_gz": {
                "path": "data/manifests/chbmit_window_index.csv.gz",
                "sha256": get_file_sha256(os.path.join(BASE_DIR, "data/manifests/chbmit_window_index.csv.gz")),
                "uncompressed_target_sha256": "f76dddb19fa2c24b3af24b989168b12465512b650c5e6d84bb0125a6d666302c"
            },
            "siena_channel_mapping_json": {
                "path": "research/experiments/siena/config/siena_channel_mapping.json",
                "sha256": get_file_sha256(os.path.join(BASE_DIR, "research/experiments/siena/config/siena_channel_mapping.json"))
            }
        },
...
def copy_final_tables_and_csvs():
    # Model comparison
    df_cmp = pd.read_csv(os.path.join(BASE_DIR, "research/experiments/ablation/results/model_comparison.csv"))
    df_cmp.to_csv(os.path.join(RESULTS_DIR, "final_model_comparison.csv"), index=False)

    # Ablation
    df_abl = pd.read_csv(os.path.join(BASE_DIR, "research/experiments/ablation/results/ablation_results.csv"))
    df_abl.to_csv(os.path.join(RESULTS_DIR, "final_ablation.csv"), index=False)

    # Patient results
    df_pat = pd.read_csv(os.path.join(BASE_DIR, "research/experiments/ablation/results/patient_level_results.csv"))
    df_pat.to_csv(os.path.join(RESULTS_DIR, "final_patient_results.csv"), index=False)

    # Event results
    df_evt = pd.read_csv(os.path.join(BASE_DIR, "research/experiments/ablation/results/event_level_results.csv"))
    ...
    # Statistical results
    df_stat = pd.read_csv(os.path.join(BASE_DIR, "research/experiments/ablation/results/statistical_tests.csv"))
    df_stat.to_csv(os.path.join(RESULTS_DIR, "final_statistical_results.csv"), index=False)

    # XAI results
    df_xai = pd.read_csv(os.path.join(BASE_DIR, "research/experiments/xai/results/channel_attribution_summary.csv"))
...
def main():
    ...
    print("  All CSV artifacts saved to research/audits/validation_audit/final_results/.")
