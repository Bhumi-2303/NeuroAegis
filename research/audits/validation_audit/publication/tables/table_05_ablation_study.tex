\begin{table*}[t]
\centering
\caption{Progressive Component Ablation and False Alarm Suppression}
\label{tab:ablation_study}
\small
\begin{tabular}{llllllllllllllll}
\toprule
ablation\_stage & component\_added & active\_modules & parameters & param\_delta & event\_sensitivity & event\_sens\_delta & fa\_24h & fa\_delta\_pct & auroc & auroc\_delta & auprc & auprc\_delta & f1\_score & f1\_delta & clinical\_finding \\
\midrule
