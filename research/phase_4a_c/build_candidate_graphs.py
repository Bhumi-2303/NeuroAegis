...
Computes all topological and edge-weight metrics and exports:
  - research/phase_4a_c/theta_025/graph_adjacency.csv
  - research/phase_4a_c/theta_025/graph_config.json
  - research/phase_4a_c/theta_030/graph_adjacency.csv
  - research/phase_4a_c/theta_030/graph_config.json
  - research/phase_4a_c/graph_threshold_comparison.csv
"""
...
def build_candidate_graphs():
    ...
    candidates = [
        ...
        {"name": "Graph C (theta=0.35, Frozen Ref)", "theta": 0.35, "dir": os.path.join(BASE_DIR, "research/phase_4a/cnn_gnn/exp_01")}
    ]
