...
Executes:
  1. Programmatic freeze & verification of research/phase_4a/frozen_graph_config.json
  ...
  7. Model complexity computation: research/phase_4a_c/final_model_complexity.json
  8. Leakage audit files: final_test_leakage_audit.json & final_test_leakage_audit.md
  9. 10 publication figures in research/phase_4a_c/figures/
...
TRAIN_CORR_PATH = os.path.join(BASE_DIR, "research/phase_4a/audit/training_correlation_matrix.npy")

PHASE4A_DIR = os.path.join(BASE_DIR, "research/phase_4a")
PHASE4AC_DIR = os.path.join(BASE_DIR, "research/phase_4a_c")
...
def main():
    ...
    frozen_config = {
        ...
        "adjacency_source_file": "research/phase_4a/frozen_graph_adjacency.csv",
...
"""
    ...
    # -------------------------------------------------------------
    print("\n[Step 7/8] Generating all 10 publication figures in research/phase_4a_c/figures/...")
    plt.rcParams.update({
    ...
    # Also mirror figures to research/phase_4a/figures/
    ...
    summary_rows = [
        ...
        ["checkpoint", "research/phase_4a/frozen_cnn_gnn.pt", "Epoch 3 (Val AUPRC: 0.00159)"],
    ...
    rep_rows = [
        ["Master Window Index", "research/data/manifests/chbmit_window_index.csv", get_file_sha256(WINDOW_INDEX_PATH)],
        ["Authoritative Training Correlation", "research/phase_4a/audit/training_correlation_matrix.npy", get_file_sha256(TRAIN_CORR_PATH)],
        ["Frozen Graph Config", "research/phase_4a/frozen_graph_config.json", get_file_sha256(FROZEN_CONFIG_PATH)],
        ["Frozen Graph Adjacency", "research/phase_4a/frozen_graph_adjacency.csv", get_file_sha256(FROZEN_ADJ_PATH)],
        ["Frozen Model Checkpoint", "research/phase_4a/frozen_cnn_gnn.pt", get_file_sha256(FROZEN_CHECKPOINT_PATH)],
        ...
        ["Model Complexity JSON", "research/phase_4a_c/final_model_complexity.json", get_file_sha256(complexity_path1)],
        ["Leakage Audit JSON", "research/phase_4a_c/final_test_leakage_audit.json", get_file_sha256(leakage_json_path)]
    ]
