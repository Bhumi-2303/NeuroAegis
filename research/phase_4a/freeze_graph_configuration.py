...
Generates:
  - research/phase_4a/frozen_graph_config.json
  - research/phase_4a/frozen_graph_adjacency.csv
  - research/phase_4a/frozen_cnn_gnn.pt
"""
...
SRC_ADJ_PATH = os.path.join(BASE_DIR, "research/phase_4a_c/theta_030/graph_adjacency.csv")
SRC_CHECKPOINT_PATH = os.path.join(BASE_DIR, "research/phase_4a_c/theta_030/best_cnn_gnn.pt")

DST_CONFIG_PATH = os.path.join(BASE_DIR, "research/phase_4a/frozen_graph_config.json")
DST_ADJ_PATH = os.path.join(BASE_DIR, "research/phase_4a/frozen_graph_adjacency.csv")
DST_CHECKPOINT_PATH = os.path.join(BASE_DIR, "research/phase_4a/frozen_cnn_gnn.pt")
