...
Performs exhaustive repository inspection and produces research/phase_4a/phase_4a_c_audit.md
"""
...
AUDIT_REPORT_PATH = os.path.join(BASE_DIR, "research/phase_4a/phase_4a_c_audit.md")
...
def run_audit():
    ...
    adj_files = {
        "theta_025": os.path.join(BASE_DIR, "research/phase_4a_c/theta_025/graph_adjacency.csv"),
        "theta_030": os.path.join(BASE_DIR, "research/phase_4a_c/theta_030/graph_adjacency.csv"),
        "theta_035": os.path.join(BASE_DIR, "research/phase_4a/cnn_gnn/exp_01/graph_adjacency.csv")
    }
    
    metrics_files = {
        "theta_025": os.path.join(BASE_DIR, "research/phase_4a_c/theta_025/validation_metrics.json"),
        "theta_030": os.path.join(BASE_DIR, "research/phase_4a_c/theta_030/validation_metrics.json"),
        "theta_035": os.path.join(BASE_DIR, "research/phase_4a_c/reference_theta035_val_metrics.json")
    }
...
| :--- | :--- | :--- |
| **Dataset** | CHB-MIT Scalp EEG (PhysioNet) | `research/data/manifests/chbmit_manifest.csv` |
| **Bipolar Montage** | Canonical 23 Channels (International 10-20) | `research/data/config/chbmit_channel_order.json` |
| **Window Duration** | 5.0 seconds (1280 samples @ 256 Hz) | `research/data/manifests/chbmit_window_index.csv` |
| **Window Stride** | 2.5 seconds (640 samples @ 256 Hz) | `research/data/manifests/chbmit_window_index.csv` |
