...
from research.phase_4a.cnn_gnn_model import SpatialGCNLayer, Baseline1DCNN_GNN
...
PHASE3_BEST_PT = os.path.join(BASE_DIR, "research/phase_3/best_cnn_baseline.pt")
