...
TEST_EVENTS_PATH = os.path.join(BASE_DIR, "research/phase_4a/final_test_event_details.csv")
TEST_PATIENTS_PATH = os.path.join(BASE_DIR, "research/phase_4a/final_test_patient_metrics.csv")
...
def generate_workbook():
    ...
    repro_rows = [
        ...
        ["Frozen Graph Config Path", "research/phase_4a/frozen_graph_config.json", ""],
        ["Frozen Checkpoint Path", "research/phase_4a/frozen_cnn_gnn.pt", ""],
        ["Final Predictions Path", "research/phase_4a/final_test_predictions.npz", ""],
        ["Final Metrics Path", "research/phase_4a/final_test_metrics.json", ""],
