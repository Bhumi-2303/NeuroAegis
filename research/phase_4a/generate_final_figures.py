...
Generates 13 publication figures in research/phase_4a/figures/:
...
FIGURES_DIR = os.path.join(BASE_DIR, "research/phase_4a/figures")
os.makedirs(FIGURES_DIR, exist_ok=True)

GRAPH_CSV_PATH = os.path.join(BASE_DIR, "research/phase_4a_c/graph_threshold_comparison.csv")
...
TEST_PREDS_PATH = os.path.join(BASE_DIR, "research/phase_4a/final_test_predictions.npz")
...
def generate_all_figures():
    ...
    adj25 = pd.read_csv(os.path.join(BASE_DIR, "research/phase_4a_c/theta_025/graph_adjacency.csv"), index_col=0).values
    adj30 = pd.read_csv(os.path.join(BASE_DIR, "research/phase_4a_c/theta_030/graph_adjacency.csv"), index_col=0).values
    adj35 = pd.read_csv(os.path.join(BASE_DIR, "research/phase_4a/cnn_gnn/exp_01/graph_adjacency.csv"), index_col=0).values
