...
Generates the authoritative 21-sheet Excel master workbook:
  research/experiments/siena/Phase_6_Siena_CrossDomain.xlsx
"""
...
def create_phase_6_workbook(
    ...
    s_rows = [
        ...
        ["Frozen Model Checkpoint", "artifacts/checkpoints/frozen_cnn_gnn_gru.pt (SHA256 verified)"],
    ...
    p_rows_summary = [
        ...
        ["Prediction Artifact Path", "research/experiments/siena/results/siena_zero_shot_predictions.csv"]
    ]
    ...
    roc_rows = [
        ...
        ["ROC Curve Figure", "research/experiments/siena/figures/fig07_siena_roc_curve.png"],
        ["PR Curve Figure", "research/experiments/siena/figures/fig08_siena_pr_curve.png"]
    ]
