...
Trains two independent CNN + GNN models under frozen Phase 4A hyperparameters:
  - Run 1: theta = 0.25 (research/experiments/gnn_candidates/theta_025/)
  - Run 2: theta = 0.30 (research/experiments/gnn_candidates/theta_030/)
...
Exports:
  - research/experiments/gnn_candidates/validation_threshold_comparison.csv
...
PHASE4A_EXP_DIR = os.path.join(BASE_DIR, "research/experiments/gnn/cnn_gnn/exp_01")
