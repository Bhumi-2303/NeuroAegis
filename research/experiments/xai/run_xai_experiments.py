...
from research.experiments.xai.xai.attribution_engine import AttributionEngine
from research.experiments.xai.xai.faithfulness_engine import FaithfulnessEngine
from research.experiments.xai.xai.raw_eeg_loader import RawEEGLoader
...
FROZEN_GRU_CONFIG = os.path.join(BASE_DIR, "research/experiments/model_c/frozen_gru_config.json")
FROZEN_MODEL_PATH = os.path.join(BASE_DIR, "artifacts/checkpoints/frozen_cnn_gnn_gru.pt")
FROZEN_GRAPH_PATH = os.path.join(BASE_DIR, "research/experiments/gnn/frozen_graph_config.json")
...
PREP_CONFIG_PATH = os.path.join(BASE_DIR, "research/experiments/windowing_labeling/preprocessing_config.json")

TEST_PREDICTIONS_PATH = os.path.join(BASE_DIR, "research/experiments/model_c/results/final_test_predictions.csv")
TEST_EVENTS_PATH = os.path.join(BASE_DIR, "research/experiments/model_c/results/final_test_event_results.csv")
TEST_PATIENTS_PATH = os.path.join(BASE_DIR, "research/experiments/model_c/results/final_test_patient_results.csv")
