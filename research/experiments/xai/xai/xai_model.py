...
class XAIModelWrapper(nn.Module):
    ...
    def __init__(
        self,
        frozen_checkpoint_path: str = os.path.join(BASE_DIR, "artifacts/checkpoints/frozen_cnn_gnn_gru.pt"),
        frozen_backbone_path: str = os.path.join(BASE_DIR, "artifacts/checkpoints/frozen_cnn_gnn.pt"),
