...
| **Model B Backbone** | `artifacts/checkpoints/frozen_cnn_gnn.pt` | 52,497 | `7d1a...` | **FROZEN (PASS)** |
| **Model C Checkpoint** | `artifacts/checkpoints/frozen_cnn_gnn_gru.pt` | 91,858 | `2ec84897c39d31d68cfbf1f7e5c8708d5073fe19450576bf4f9132929c1832ca` | **FROZEN (PASS)** |
...
| **Master Window Index** | `data/manifests/chbmit_window_index.csv` | 1,414,710 windows | `f76dddb19fa2c24b3af24b989168b12465512b650c5e6d84bb0125a6d666302c` | **FROZEN (PASS)** |
