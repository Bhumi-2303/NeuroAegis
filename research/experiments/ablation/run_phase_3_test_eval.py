...
Saves predictions to research/experiments/ablation/results/phase_3_test_predictions.npz
...
MANIFEST_PATH = os.path.join(BASE_DIR, "data/manifests/chbmit_manifest.csv")
EDF_ROOT_DIR = os.path.join(BASE_DIR, "CHB-MIT Dataset")
CHECKPOINT_PATH = os.path.join(BASE_DIR, "research/experiments/cnn_baseline/best_cnn_baseline.pt")
OUTPUT_NPZ = os.path.join(BASE_DIR, "research/experiments/ablation/results/phase_3_test_predictions.npz")
OUTPUT_PATIENT_CSV = os.path.join(BASE_DIR, "research/experiments/ablation/results/phase_3_patient_results.csv")
OUTPUT_EVENT_CSV = os.path.join(BASE_DIR, "research/experiments/ablation/results/phase_3_event_results.csv")
