...
Exports:
  - research/experiments/gnn/final_test_metrics.json
  - research/experiments/gnn/final_test_predictions.npz
  - research/experiments/gnn/final_test_event_details.csv
  - research/experiments/gnn/final_test_patient_metrics.csv
"""
...
FROZEN_CHECKPOINT_PATH = os.path.join(BASE_DIR, "artifacts/checkpoints/frozen_cnn_gnn.pt")
OUTPUT_METRICS_PATH = os.path.join(BASE_DIR, "research/experiments/gnn/final_test_metrics.json")
OUTPUT_PREDS_PATH = os.path.join(BASE_DIR, "research/experiments/gnn/final_test_predictions.npz")
OUTPUT_EVENTS_CSV = os.path.join(BASE_DIR, "research/experiments/gnn/final_test_event_details.csv")
OUTPUT_PATIENTS_CSV = os.path.join(BASE_DIR, "research/experiments/gnn/final_test_patient_metrics.csv")
