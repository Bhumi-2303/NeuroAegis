...
Executes an exhaustive forensic audit of the Phase 6 cross-domain evaluation:
  ...
  8. Emits the master 18-sheet Excel audit workbook: research/phase_6/audit/phase_6b_audit.xlsx.
  9. Emits the reconciled summary JSON: research/phase_6/audit/phase_6b_reconciled_summary.json.
"""
...
FROZEN_CHECKPOINT_PATH = os.path.join(BASE_DIR, "research/phase_4b/frozen_cnn_gnn_gru.pt")
...
def run_forensic_audit():
    ...
    repro_rows = [
        ...
        ["Frozen Model Checkpoint", "research/phase_4b/frozen_cnn_gnn_gru.pt", "Byte-for-byte unchanged"],
        ["Checkpoint SHA256", ckpt_hash, "Matches authoritative hash exactly"],
        ["Frozen Graph Adjacency", "research/phase_4a/frozen_graph_adjacency.csv", "theta = 0.30, 23 nodes, 40 edges"],
