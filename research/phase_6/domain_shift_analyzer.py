...
CHBMIT_RESULTS_PATH = os.path.join(BASE_DIR, "research/phase_4b/results/final_test_metrics.json")
CHBMIT_PATIENT_PATH = os.path.join(BASE_DIR, "research/phase_4b/results/final_test_patient_results.csv")
