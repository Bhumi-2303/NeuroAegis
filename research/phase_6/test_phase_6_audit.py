...
class TestPhase6Audit(unittest.TestCase):
    ...
    def test_05_reconstructed_channels_have_no_nan_or_inf(self):
        ...
        from research.phase_6.siena_preprocessor import SienaChannelHarmonizer
    ...
    def test_06_sampling_rate_decimation_is_factor_of_two(self):
        ...
        from research.phase_6.siena_preprocessor import SienaPreprocessor
    ...
    def test_07_input_tensor_shape_is_correct(self):
        ...
        from research.phase_6.siena_preprocessor import SienaWindowExtractor, SienaSequenceBuilder
    ...
    def test_08_causality_invariant_holds(self):
        ...
        from research.phase_6.siena_preprocessor import SienaSequenceBuilder
