...
Generates the 19-sheet master workbook: research/phase_7/Phase_7_Statistical_Robustness.xlsx
...
def build_workbook():
    ...
    summary_rows = [
        ...
        ["Spatial Graph Config", "research/phase_4a/frozen_graph_config.json"],
    ...
    repro_rows = [
        ...
        ["Model C Checkpoint", "research/phase_4b/frozen_cnn_gnn_gru.pt"],
    ...
    write_sheet_header(ws18, "Publication Figure Registry (300 DPI)", 
                       "Comprehensive index of 16 high-resolution publication figures generated in research/phase_7/figures/")
    fig_rows = [
