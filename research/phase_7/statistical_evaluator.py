...
Generates all 11 required machine-readable result files in research/phase_7/results/.
"""
...
P4A_PRED_PATH = os.path.join(BASE_DIR, "research/phase_4a_c/final_test_predictions.csv")
P4B_PRED_PATH = os.path.join(BASE_DIR, "research/phase_4b/results/final_test_predictions.csv")
P4B_VAL_PATH = os.path.join(BASE_DIR, "research/phase_4b/experiments/L8/val_predictions.npz")

P3_METRICS_PATH = os.path.join(BASE_DIR, "research/phase_3/phase_3_metrics.json")
P4A_EVENT_PATH = os.path.join(BASE_DIR, "research/phase_4a_c/final_test_event_results.csv")
P4B_EVENT_PATH = os.path.join(BASE_DIR, "research/phase_4b/results/final_test_event_results.csv")

EVENTS_MANIFEST_PATH = os.path.join(BASE_DIR, "research/data/manifests/chbmit_seizure_events.csv")
RECORDINGS_MANIFEST_PATH = os.path.join(BASE_DIR, "research/data/manifests/chbmit_manifest.csv")
...
def run_statistical_evaluation():
    ...
    summary_json = {
        ...
        "model_architecture_freeze": {
            "model_c_checkpoint": "research/phase_4b/frozen_cnn_gnn_gru.pt",
            "model_c_sha256": get_file_sha256(os.path.join(BASE_DIR, "research/phase_4b/frozen_cnn_gnn_gru.pt")),
            "spatial_graph_config": "research/phase_4a/frozen_graph_config.json",
            "spatial_graph_config_sha256": get_file_sha256(os.path.join(BASE_DIR, "research/phase_4a/frozen_graph_config.json")),
            "spatial_graph_adjacency": "research/phase_4a/frozen_graph_adjacency.csv",
            "spatial_graph_adjacency_sha256": get_file_sha256(os.path.join(BASE_DIR, "research/phase_4a/frozen_graph_adjacency.csv")),
            "spatial_graph_sha256": get_file_sha256(os.path.join(BASE_DIR, "research/phase_4a/frozen_graph_adjacency.csv")),
