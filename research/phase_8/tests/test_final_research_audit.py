...
PUB_DIR = os.path.join(BASE_DIR, "research/phase_8/publication")
...
class TestFinalResearchAudit(unittest.TestCase):
    ...
    def test_10_leakage_audit(self):
        ...
        with open(os.path.join(BASE_DIR, "research/phase_4b/frozen_gru_config.json")) as f:
            gru_cfg = json.load(f)
    ...
    def test_13_publication_figures_presence(self):
        ...
        actual_figs = os.listdir(os.path.join(BASE_DIR, "research/phase_8/figures"))
    ...
    def test_15_master_workbook_presence_and_sheet_count(self):
        import openpyxl
        wb_path = os.path.join(BASE_DIR, "research/phase_8/NeuroAegis_Final_Research_Results.xlsx")
