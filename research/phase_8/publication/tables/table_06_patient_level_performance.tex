\begin{table*}[t]
\centering
\caption{Patient-Specific Seizure Detection and False Alarm Breakdown}
\label{tab:patient_level_performance}
\small
\begin{tabular}{llllllllllllllllll}
\toprule
patient\_id & model\_id & architecture\_name & total\_windows & recording\_hours & num\_seizures & detected\_seizures & missed\_seizures & event\_sensitivity & window\_sensitivity & window\_specificity & window\_precision & f1\_score & auroc & auprc & false\_alarms\_count & false\_alarms\_per\_day & mean\_detection\_delay\_sec \\
\midrule
