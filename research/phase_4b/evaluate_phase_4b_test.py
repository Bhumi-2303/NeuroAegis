...
FROZEN_GRAPH_CFG_PATH = os.path.join(BASE_DIR, "research/phase_4a/frozen_graph_config.json")
...
def run_phase_4b_final_test():
    ...
    from research.phase_4b.train_cnn_gnn_gru import compute_detection_delay_details, compute_patient_breakdown
